...
for i in image_folder:
    nimages = len(os.listdir('/home/cyp/weather/dataset/'+i+'/'))
    nimgs[i]=nimages
...
for i in image_folder:
    sample_images = list(pathlib.Path('/home/cyp/weather/dataset/'+i+'/').glob('*'))  # 使用glob而不是rglob
    np.random.seed(42)
    # 确保有足够的图片可供选择
...
BASE_DIR = '/home/cyp/weather/weather_pred'
...
# 设置源目录和目标目录
CLOUDY_SOURCE_DIR = '/home/cyp/weather/dataset/cloudy/'
TRAINING_CLOUDY_DIR = '/home/cyp/weather/weather_pred/Data/training/cloudy/'
VALID_CLOUDY_DIR = '/home/cyp/weather/weather_pred/Data/validation/cloudy/'

FOGGY_SOURCE_DIR = '/home/cyp/weather/dataset/foggy/'
TRAINING_FOGGY_DIR = '/home/cyp/weather/weather_pred/Data/training/foggy/'
VALID_FOGGY_DIR = '/home/cyp/weather/weather_pred/Data/validation/foggy/'

RAINY_SOURCE_DIR = '/home/cyp/weather/dataset/rainy/'
TRAINING_RAINY_DIR = '/home/cyp/weather/weather_pred/Data/training/rainy/'
VALID_RAINY_DIR = '/home/cyp/weather/weather_pred/Data/validation/rainy/'

SHINE_SOURCE_DIR = '/home/cyp/weather/dataset/shine/'
TRAINING_SHINE_DIR = '/home/cyp/weather/weather_pred/Data/training/shine/'
VALID_SHINE_DIR = '/home/cyp/weather/weather_pred/Data/validation/shine/'

SUNRISE_SOURCE_DIR = '/home/cyp/weather/dataset/sunrise/'
TRAINING_SUNRISE_DIR = '/home/cyp/weather/weather_pred/Data/training/sunrise/'
VALID_SUNRISE_DIR = '/home/cyp/weather/weather_pred/Data/validation/sunrise/'
...
nimgs = {}
for i in image_folder:
    train_path = f'/home/cyp/weather/weather_pred/Data/training/{i}/'
...
nimgs = {}
for i in image_folder:
    valid_path = f'/home/cyp/weather/weather_pred/Data/validation/{i}/'
